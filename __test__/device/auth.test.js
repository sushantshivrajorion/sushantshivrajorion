...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ruby6',
      password: '8KXT0j41yTugaTv',
      email: 'Halie.Schaden@yahoo.com',
      name: 'Sandra Cummings',
      userType: 943,
      mobileNo: '(941) 102-6795',
      resetPasswordLink: {},
      loginRetryLimit: 793,
      loginReactiveTime: '2023-07-20T15:38:42.219Z',
      id: '640078f6ffdd6dafbe40c837'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Sophie_Fritsch',
        'password':'0ktgyvnfluGiqbe',
        'email':'Enrico30@gmail.com',
        'name':'Ms. Gerardo Kub',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(419) 283-2293',
